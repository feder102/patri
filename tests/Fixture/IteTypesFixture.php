 ...
 *
 */
class IteTypesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'type_item_class_idx' => ['type' => 'index', 'columns' => ['item_class_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'type_item_class' => ['type' => 'foreign', 'columns' => ['item_class_id'], 'references' => ['ite_classes', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
